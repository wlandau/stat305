...
\end{itemize}
\pause \begin{center}
<<echo=F, out.width = "0.6\\textwidth", out.height = "0.6\\textheight", small.mar = T>>=
curve(dnorm(x), from = -4, to = 4, ylim = c(0, .45))
abline(v = qnorm(0.95))
abline(v = qnorm(0.05))
...
shade_under_curve(dnorm, -4, qnorm(0.05))
shade_under_curve(dnorm, qnorm(0.95), 4)

text(x = 2.35, y = .3, labels = "z_0.95", cex = 1.5)
text(x = -2.35, y = .3, labels = "z_0.05", cex = 1.5)

legend("topright", cex = 1.25, fill = "blue", legend = "Integral over rejection region = alpha")
@
\end{center}
\end{frame}
...
shade_under_curve(dnorm, -4, qnorm(0.1))
text(x = -2, y = .3, labels = "z_0.1", cex = 1.5)
legend("topright", cex = 1.25, fill = "blue", legend = "Integral over rejection region = alpha")
@
...
shade_under_curve(dnorm, qnorm(0.95), 4)
text(x = 2.4, y = .3, labels = "z_0.95", cex = 1.5)
legend("topright", cex = 1.25, fill = "blue", legend = "Integral over rejection region = alpha")
@
...
<<echo=F, out.width = "0.6\\textwidth", out.height = "0.6\\textheight", small.mar = T>>=
curve(dnorm(x), from = -4, to = 4, ylim = c(0, .5))
abline(v = qnorm(0.95))
abline(v = qnorm(0.05))

shade_under_curve <- function(fun, xmin, xmax, length=100, col="blue"){
  xvals <- seq(xmin, xmax, length=length)
  dvals <- match.fun(fun)(xvals)
...
text(x = 1.25, y = .35, labels = "z_0.95", cex = 1.2)
text(x = -2.2, y = .3, labels = "z_0.05", cex = 1.2)
text(labels = "K = 2.5", x = 3, y = .05, cex = 1.2)


abline(v = 2.5)

shade_under_curve(dnorm, 2.5, 4, col="red")
shade_under_curve(dnorm, -4, -2.5, col="red")

legend("topleft", cex = 1.25, fill = c("blue", "red"), legend = c("Integral over rejection region = alpha)",
                                                                   "p-value = P(|N(0,1)| > |K|)"))
@
\end{center}
\end{frame}
