...
\begin{center}
\setkeys{Gin}{width=.5\textwidth} \includegraphics{../../fig/gearstable.png} 
\end{center}
...
\frametitle{Summary}
\begin{center}
\setkeys{Gin}{width=.4\textwidth} \includegraphics{../../fig/gearsdot.png} 
\end{center}
...
\begin{center}
\setkeys{Gin}{width=.55\textwidth} \includegraphics{../../fig/papertable.png} \q \includegraphics{../../fig/paperdot.png} 
\end{center}
...
\begin{center}
\setkeys{Gin}{width=.75\textwidth} \includegraphics{../../fig/gearstable.png} 
\end{center}
...
\begin{center}
\setkeys{Gin}{width=.4\textwidth} \includegraphics{../../fig/brittleschematic.png}
\end{center}
