...
\end{itemize}
\setkeys{Gin}{width=.7\textwidth} \includegraphics{../../fig/normalsimplereg.png}
\begin{itemize}
...
\begin{align*}
\uncover<2->{K = \frac{\wh{\mu}_{y \mid x} - \#}{  s_{LF} \sqrt{    \frac{1}{n} +  \frac{(x - \ov{x})^2}{\sum_i(x_i - \ov{x})^2}}}}
\end{align*}
...
\begin{align*}
\uncover<4->{K = \frac{b_0 - 0}{  s_{LF} \sqrt{    \frac{1}{n} +  \frac{(0 - \ov{x})^2}{\sum_i(x_i - \ov{x})^2}}}}  \uncover<5->{= \frac{b_0 }{  s_{LF} \sqrt{    \frac{1}{n} +  \frac{ \ov{x}^2}{\sum_i(x_i - \ov{x})^2}}}}
\end{align*}
\begin{itemize}
\uncover<6->{\item $K \sim t_{n - 2}$ assuming:}
\begin{itemize}
...
\setkeys{Gin}{width=1\textwidth} \includegraphics{../../fig/xkcd1.png}
\end{frame}

\begin{frame}
\frametitle{Example: \url{http://xkcd.com/882/}}
\setkeys{Gin}{width=1\textwidth} \includegraphics{../../fig/xkcd2.png}
\end{frame}

\begin{frame}
\frametitle{Example: \url{http://xkcd.com/882/}}
\setkeys{Gin}{width=1\textwidth} \includegraphics{../../fig/xkcd3.png}
\end{frame}

\begin{frame}
\frametitle{Example: \url{http://xkcd.com/882/}}
\begin{center}
\setkeys{Gin}{width=.7\textwidth} \includegraphics{../../fig/xkcd4.png}
\end{center}
\end{frame}
...
\begin{frame}
\frametitle{Simultaneous confidence intervals for $\mu_{y \mid x}$}
\setkeys{Gin}{width=.8\textwidth} \includegraphics{../../fig/simconf.png}
\end{frame}
...
\setkeys{Gin}{width=.6\textwidth} \includegraphics{../../fig/scp1.png}
\end{frame}


\begin{frame}
\frametitle{Ceramics; plotting simultaneous confidence regions}
\setkeys{Gin}{width=.6\textwidth} \includegraphics{../../fig/scp2.png}
\end{frame}


\begin{frame}
\frametitle{Ceramics; plotting simultaneous confidence regions}
\setkeys{Gin}{width=.6\textwidth} \includegraphics{../../fig/scp3.png}
\end{frame}

\begin{frame}
\frametitle{Ceramics; plotting simultaneous confidence regions}
\setkeys{Gin}{width=.6\textwidth} \includegraphics{../../fig/scp4.png}
\end{frame}

\begin{frame}
\frametitle{Ceramics: calculating the margins of error in JMP}
\setkeys{Gin}{width=1\textwidth} \includegraphics{../../fig/jfs2.png}
\end{frame}

\begin{frame}
\frametitle{Ceramics: calculating the margins of error in JMP}
\setkeys{Gin}{width=.8\textwidth} \includegraphics{../../fig/jfs3.png}
\end{frame}

\begin{frame}
\frametitle{Ceramics: calculating the margins of error in JMP}
\setkeys{Gin}{width=1\textwidth} \includegraphics{../../fig/jfs4.png}
\end{frame}

\begin{frame}
\frametitle{Ceramics: calculating the margins of error in JMP}
\setkeys{Gin}{width=1\textwidth} \includegraphics{../../fig/simuljmp11.png}
\end{frame}

\begin{frame}
\frametitle{Ceramics: calculating the margins of error in JMP}
\setkeys{Gin}{width=1\textwidth} \includegraphics{../../fig/simuljmp12.png}
\end{frame}

\begin{frame}
\frametitle{Ceramics: calculating the margins of error in JMP}
\setkeys{Gin}{width=1\textwidth} \includegraphics{../../fig/simuljmp21.png}
\end{frame}

\begin{frame}
\frametitle{Ceramics: calculating the margins of error in JMP}
\setkeys{Gin}{width=1\textwidth} \includegraphics{../../fig/simuljmp22.png}
\end{frame}
