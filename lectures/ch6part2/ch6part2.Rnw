...
\begin{center}
<<fig.height = 5, fig.width = 5, out.height = ".4\\textheight", out.width = ".4\\textwidth", small.mar = T, echo=F>>=
qqnorm(c(.83, .88, .88, 1.04, 1.09, 1.12, 1.29, 1.31, 1.48, 1.49, 1.59, 1.62, 1.65, 1.71, 1.76, 1.83), datax = T,
main = "", xlab = "", ylab = "")
qqline(c(.83, .88, .88, 1.04, 1.09, 1.12, 1.29, 1.31, 1.48, 1.49, 1.59, 1.62, 1.65, 1.71, 1.76, 1.83), datax = T)
@
\end{center}
