...
\item Is this study an experiment or an observational study? Why?
\item Identify and classify all the variables in this study.
\item Identify the treatment groups, if any, and state how many there are. 
\end{enumerate}
