...
\setkeys{Gin}{width=.7\textwidth} \includegraphics{../../fig/h7p2.png}

\item \q
\setkeys{Gin}{width=.8\textwidth} \includegraphics{../../fig/h7p3.png}
\item \q
\setkeys{Gin}{width=.8\textwidth} \includegraphics{../../fig/h7p4.png}
