...
\setkeys{Gin}{width=1\textwidth} \includegraphics{../../fig/h9p1sol.png}

\item Use the method of critical values (not p-values) in the following problem. You may assume that the test statistic has a N(0,1) distribution. \q
\setkeys{Gin}{width=1\textwidth} \includegraphics{../../fig/h9p2-1.png}
\setkeys{Gin}{width=1\textwidth} \includegraphics{../../fig/h9p2-2.png}
\setkeys{Gin}{width=1\textwidth} \includegraphics{../../fig/h9p2sol.png}
...
\setkeys{Gin}{width=1\textwidth} \includegraphics{../../fig/h9p3sol.png}

\item Use the method of p-values in the following problem. \q
\setkeys{Gin}{width=1\textwidth} \includegraphics{../../fig/h9p4.png}
\setkeys{Gin}{width=1\textwidth} \includegraphics{../../fig/h9p4sol.png}
...
\setkeys{Gin}{width=1\textwidth} \includegraphics{../../fig/h9p6sol1.png}
\setkeys{Gin}{width=1\textwidth} \includegraphics{../../fig/h9p6sol2.png}
\setkeys{Gin}{width=1\textwidth} \includegraphics{../../fig/h9p6sol3.png}
