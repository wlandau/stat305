...
$\quad$ \newline \includegraphics[scale=0.5,angle=0]{../../fig/2} \newline
...
$\quad$ \newline \includegraphics[scale=0.5,angle=0]{../../fig/3} \newline
...
$\quad$ \newline \includegraphics[scale=0.5,angle=0]{../../fig/5} \newline
...
\item 
\setkeys{Gin}{width=1\textwidth} \includegraphics{../../fig/ch5s2p1.png}
\setkeys{Gin}{width=1\textwidth} \includegraphics{../../fig/ch5s2p1sol1.png}
\setkeys{Gin}{width=1\textwidth} \includegraphics{../../fig/ch5s2p1sol2.png}
...
\begin{enumerate}[a. ]
\item \setkeys{Gin}{width=1\textwidth} \includegraphics{../../fig/hw5esola.png}
\item \setkeys{Gin}{width=1\textwidth} \includegraphics{../../fig/hw5esolb.png}
\end{enumerate}
